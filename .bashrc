...
PATH="$HOME/.cargo/env${PATH:+:${PATH}}"
PATH="$HOME/.emacs.d/bin${PATH:+:${PATH}}"
PATH="$HOME/.cargo/bin${PATH:+:${PATH}}"
PATH="/home/buddha/.local/bin${PATH:+:${PATH}}"
...
bash_prompt() {
	...
	## CONFIGURATION: BUDDHA-sakya
	if [ "$HOSTNAME" = Shakyamuni ]; then
		FONT_COLOR_1=$CYAN;
		BACKGROUND_1=$RED;
		TEXTEFFECT_1=$BOLD;
...
__conda_setup="$('/home/buddha/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/buddha/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/buddha/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/buddha/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
